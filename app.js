...
// =============================================
const STATION_ICONS = {
  "كلمة": "📖", "لعبة": "🎯", "لعب": "🎮", "لعب (سمر)": "🔥",
  "تأسلق": "🧗", "تأسلق صيحات": "📢", "تأسلق رياضي": "⚽",
  "سمر": "🔥", "شفرة": "🔐", "شفرات": "🔐",
  "Spin": "🎰", "spin": "🎰", "بريك": "☕",
  "رياضي": "⚽", "كشمر": "🎭", "تأملات صيحات": "🙏",
  "بالقاء": "🎤", "جماعية": "👥", "لعبة جماعية": "👥",
  "تمرك": "🏕️", "تمر": "🏕️", "لعبة جماعية + كشمر": "🎭",
  "لعبة جماعية + كشمر": "🎭"
};
...
const ROUTES = {
  1: {
    ...
    password: "1",
    days: {
      1: ["تمرك", "تأسلق صيحات", "تأسلق رياضي", "سمر", "لعبة جماعية"],
      2: ["كلمة", "لعبة", "لعب (سمر)", "لعب (سمر)", "شفرات", "كلمة", "سمر", "بريك", "تأسلق", "Spin", "سمر", "كلمة"],
      3: ["سمر", "Spin", "كلمة", "كلمة", "لعب (سمر)", "بريك", "كلمة", "تأسلق", "سمر", "كلمة", "Spin"]
    }
  },
  2: {
    name: "طليعة ٢",
    password: "2",
    days: {
      1: ["تأملات صيحات", "Spin", "تأسلق", "رياضي", "كشمر", "لعبة", "بالقاء", "جماعية"],
      2: ["لعبة", "شفرة", "لعبة", "كلمة", "لعبة", "Spin", "كلمة", "كلمة", "بريك", "كلمة", "تأسلق", "لعبة"],
      3: ["لعبة", "كلمة", "كلمة", "تأسلق", "بريك", "Spin", "لعبة", "كلمة", "Spin", "لعبة", "كلمة"]
    }
  },
  3: {
    name: "طليعة ٣",
    password: "3",
    days: {
      1: ["Spin", "تأسلق صيحات", "تأسلق", "سمر", "تأسلق رياضي", "لعبة جماعية + كشمر"],
      2: ["سمر", "سمر", "شفرات", "كلمة", "بريك", "سمر", "كلمة", "Spin", "تأسلق", "كلمة", "سمر"],
      3: ["Spin", "سمر", "كلمة", "سمر", "تأسلق", "سمر", "بريك", "سمر", "كلمة", "Spin", "كلمة"]
    }
  },
  4: {
    name: "طليعة ٤",
    password: "4",
    days: {
      1: ["تأسلق صيحات", "Spin", "سمر", "تأسلق رياضي", "لعبة جماعية"],
      2: ["شفرة", "كلمة", "لعبة", "لعبة", "Spin", "لعبة", "كلمة", "كلمة", "بريك", "لعبة", "تأسلق"],
      3: ["كلمة", "لعبة", "بريك", "Spin", "تأسلق", "كلمة", "Spin", "كلمة", "لعبة", "Spin"]
    }
  }
};
